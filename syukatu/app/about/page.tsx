...
export default function AboutPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center">
      ...
      font-extrabold text-gray-900 sm:text-5xl md:text-6xl bg-white shadow-md py-4 z-100">
          就活情報共有プラットフォーム　〇〇
      ...
      <div className='auth-card'>
        <div className='space-y-6'>
          ...
          <h1 className="text-3xl font-bold mb-3">Aboutページです</h1>
          <p className="text-lg mb-8">これはAboutページの内容です。さてさて・・どれぐらいの長さか見せてもらうとしますか・・・</p>
        </div>
      </div>
      <div className='auth-card'>
        <div className='space-y-6'>
